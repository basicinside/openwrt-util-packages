 ...
 *
 * Ported to OpenWRT and minor modifications by
 * by Robin Kuck <robin@basicinside.de>
 */
...
int main(int argc, char **argv)
{
	...
	enum {DO_POWER, DO_STATUS, DO_BIND, DO_RESET} action;
	...
	snprintf(fname1, 39, "/dev/bus/usb/%03d/%03d", busnum, devnum);
	snprintf(fname2, 39, "/proc/bus/usb/%03d/%03d", busnum, devnum);
